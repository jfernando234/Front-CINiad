...
@Component({
  selector: 'app-add-detalles-programas',
  templateUrl: './add-detalles.component.html',
  styleUrls: ['./add-detalles.component.scss']
})
export class AddDetallesProgramasComponent implements OnInit {
  form!: FormGroup;
  ...
  crearDetalle() {
    ...
    // Caller should handle adding the detail; here we'll just close modal
